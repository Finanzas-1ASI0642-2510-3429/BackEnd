package pe.edu.upc.finance.amortization.iam.domain.model.entities;
...
import lombok.With;
import pe.edu.upc.finance.amortization.iam.domain.model.valueobjects.Roles;
...
public class Role {
    ...
    public static Role getDefaultRole() {
        return new Role(Roles.ROLE_EMISOR);
    }
